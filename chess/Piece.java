...
public class Piece {
    ...
    public void checkPawnPromotion(){
      Character charInstance = this.getCharacter();
      if (((charInstance == '\u265f') && (this.row == 7)) || ((charInstance == '\u2659') && (this.row == 0))){
        Scanner s = new Scanner(System.in);
        System.out.println("What piece would you like to promote the pawn to?");
        String userInput = s.nextLine();
        this.selectPiece(userInput);
      }
    }
    ...
    public void selectPiece(String userInput){
      boolean isBlack = this.getIsBlack();
